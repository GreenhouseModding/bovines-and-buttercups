...
public class BovinesRegistryKeys {
    ...
    public static final ResourceKey<Registry<PlaceableEdibleType>> EDIBLE_BLOCK_TYPE = ResourceKey.createRegistryKey(BovinesAndButtercups.asResource("edible_block"));
