...
public class BovinesFlowerCrownMaterials {
    public static final ResourceKey<FlowerCrownMaterial> ALSTROEMERIA = ResourceKey.create(BovinesRegistryKeys.FLOWER_CROWN_MATERIAL, BovinesAndButtercups.asResource("alstroemeria"));
    ...
    public static void bootstrap(BootstrapContext<FlowerCrownMaterial> context) {
        context.register(ALSTROEMERIA, createFromKey(BovinesItems.ALSTROEMERIA, ALSTROEMERIA, ColorConstants.ALSTROEMERIA));
