...
public class BovinesBlocks {
    ...
    public static final FlowerBlock HYACINTH = register(BovinesAndButtercups.asResource("hyacinth"), new TagPlaceableFlowerBlock(MobEffects.POISON, 12, BovinesTags.BlockTags.HYACINTH_PLACEABLE, BlockBehaviour.Properties.of().noCollission().randomTicks().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    public static final FlowerBlock SNOWDROP = register(BovinesAndButtercups.asResource("snowdrop"), new TagPlaceableFlowerBlock(MobEffects.MOVEMENT_SLOWDOWN, 5, BovinesTags.BlockTags.SNOWDROP_PLACEABLE, BlockBehaviour.Properties.of().noCollission().randomTicks().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    public static final FlowerBlock TROPICAL_BLUE = register(BovinesAndButtercups.asResource("tropical_blue"), new TagPlaceableFlowerBlock(MobEffects.FIRE_RESISTANCE, 4, BovinesTags.BlockTags.TROPICAL_BLUE_PLACEABLE, BlockBehaviour.Properties.of().noCollission().randomTicks().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    public static final FlowerBlock FREESIA = register(BovinesAndButtercups.asResource("freesia"), new TagPlaceableFlowerBlock(MobEffects.WATER_BREATHING, 8, BovinesTags.BlockTags.FREESIA_PLACEABLE, BlockBehaviour.Properties.of().noCollission().randomTicks().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final CustomMushroomBlock CUSTOM_MUSHROOM = register(BovinesAndButtercups.asResource("custom_mushroom"), new CustomMushroomBlock(BlockBehaviour.Properties.of().noCollission().randomTicks().instabreak().sound(SoundType.GRASS).lightLevel((value) -> 1)));
    ...
    public static final PlaceableEdibleBlock PLACEABLE_EDIBLE = register(BovinesAndButtercups.asResource("placeable_edible"), new PlaceableEdibleBlock(BlockBehaviour.Properties.of().strength(0.5F).sound(SoundType.WOOL).pushReaction(PushReaction.DESTROY).dynamicShape().lightLevel(value -> value.getValue(PlaceableEdibleBlock.LIGHT))));

    public static void registerAll() {}

    private static <T extends Block> T register(ResourceLocation id, T block) {
