...
public class BovinesCriteriaTriggers {
    ...
    public static void registerAll(RegistrationCallback<CriterionTrigger<?>> callback) {
        callback.register(BuiltInRegistries.TRIGGER_TYPES, BreedCowWithVariantTrigger.ID, BreedCowWithVariantTrigger.INSTANCE);
        callback.register(BuiltInRegistries.TRIGGER_TYPES, ConvertMoobloomFromSculkTrigger.ID, ConvertMoobloomFromSculkTrigger.INSTANCE);
