...
public record MooshroomConfiguration(Settings settings,
    ...
    public static MooshroomConfiguration createMissing(RegistryOps.RegistryInfoLookup lookup) {
        return new MooshroomConfiguration(new BaseCowConfiguration.Settings(Optional.of(BovinesAndButtercups.asResource("bovinesandbuttercups/moobloom/missing_mooshroom")),
