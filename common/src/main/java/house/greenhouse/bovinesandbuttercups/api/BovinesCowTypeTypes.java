...
public class BovinesCowTypeTypes {
    ...
    public static final CowTypeType<MooshroomConfiguration> MOOSHROOM_TYPE = new CowTypeType<>(MooshroomConfiguration.CODEC, List.of(EntityType.MOOSHROOM), BovinesCowTypes.MooshroomKeys.MISSING_MOOSHROOM,"bovinesandbuttercups/mooshroom/%s_mooshroom", MooshroomConfiguration::createMissing);
