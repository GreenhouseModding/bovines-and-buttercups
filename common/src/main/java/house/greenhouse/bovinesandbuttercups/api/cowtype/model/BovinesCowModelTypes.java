...
public class BovinesCowModelTypes {
    ...
    public static final CowModelType DECORATION = new CowModelType(BovinesAndButtercups.MOD_ID, "decoration","_baby");
    ...
    public static void registerAll(RegistrationCallback<CowModelType> callback) {
        ...
        callback.register(BovinesRegistries.MODEL_TYPE, BovinesAndButtercups.asResource("decoration"), DECORATION);
    }
}
